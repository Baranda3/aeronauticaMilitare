...
$conn = mysqli_connect('localhost', 'root', 'root', 'aeronautica_db') or die("could not connect");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_action'])) {
    if ($_POST['product_action'] === 'update') {
        ...
        $updateQuery = "UPDATE Products SET ProductName='$productName', Gender='$gender', Category='$category', Subcategory='$subcategory', Description='$description', Price='$price', Stock='$stock' WHERE ProductId='$id'";
        mysqli_query($conn, $updateQuery) or die("Update unsuccessful");
        ...
        $addQuery = "INSERT INTO Products (ProductName, Gender, Category, Subcategory, Description, Price, Stock) VALUES ('$productName', '$gender', '$category', '$subcategory', '$description', '$price', '$stock')";
        mysqli_query($conn, $addQuery) or die("Add unsuccessful");
    }
}
